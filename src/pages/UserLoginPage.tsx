    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg p-8 space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white px-3 text-gray-400">या</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-gray-200 hover:bg-gray-50 text-gray-700 py-3.5 rounded-xl font-medium transition-colors"
          >
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          नया यूज़र हैं?{' '}
          <button onClick={() => navigate('/signup')} className="text-emerald-700 font-medium hover:text-emerald-800">
            अकाउंट बनाएं
          </button>
        </p>
      </div>
